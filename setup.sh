...
echo ""
echo "Next steps:"
echo "  1. Log in (it tells you exactly what to paste):"
echo "       leetcode-save --login"
echo ""
echo "  2. Solve something on leetcode.com, then run:"
echo "       leetcode-save"
echo ""
echo "That's it. --login finds your solutions repo, or offers to create"
echo "one for you. You never have to edit a config file by hand."
